from filters import (
    EqualFilter, GreaterThanFilter, LessThanFilter, GreaterThanEqualToFilter,
    LessThanEqualToFilter, BetweenFilter, LessThanGreaterThanFilter, InFilter,
    NotInFilter
)
...
q_filters = [
    EqualFilter(), GreaterThanEqualToFilter(), NotInFilter()]
